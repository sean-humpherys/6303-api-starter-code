...
with sqlite3.connect(db_name) as conn:
    ...
    for row in cursor:
        if row[0] == correct_record_count: 
            ...
            print(f"*** FAIL. Record Count: {row[0]}. Should be {correct_record_count}. Need to try again.")
    print("----- Test 2 -----")
    ...
    for row in cursor:
        if row[0] > correct_record_count: 
            ...
            print(f"*** PASSES. Column headres successful removed before importing data. ")
    print("----- Test 3 -----")
    ...
    for row in cursor:
        if row[0] == correct_record_count: 
            ...
            print(f"*** FAIL. Missing key data vales or data is duplicated. Need to try again. ")